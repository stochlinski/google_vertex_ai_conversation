...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Required(CONF_CREDENTIALS, default=DEFAULT_CREDENTIALS): str,
    }
)
...
async def validate_input(hass: HomeAssistant, data: dict[str, Any]) -> None:
    ...
    """
    credentials, project_id = load_credentials_from_file(filename=data[CONF_CREDENTIALS]);
    vertexai.init(project=project_id, location=data[CONF_LOCATION], credentials=credentials)
